...
def f_equation_inverse_simple_norm(x, y, t, feature_mat, pinn_example):
    ...
    f_equation_x = u_t*U1/t0 + u * u_x*U1*U1/L1 + v * u_y*U1*U2/L2 + lam1 * p_x*p0/L1 - lam2 * (u_xx*U1/(L1*L1) + u_yy*U1/(L2*L2))
    f_equation_y = v_t*U2/t0 + u * v_x*U1*U2/L1 + v * v_y*U2*U2/L2 + lam1 * p_y*p0/L2 - lam2 * (v_xx*U2/(L1*L1) + v_yy*U2/(L2*L2))
